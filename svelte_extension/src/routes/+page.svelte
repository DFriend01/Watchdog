<script lang="ts">
    ...
    const questions = [
        ...
        },
        {
            ...
            prompt: `
                You are an AI assistant that helps consumers identify misinformation on the internet. It is important to note that scams are a form of
                misinformation, so if you believe that the text is a scam, then it is also misinformation.
                
                Detect if the provided text after the triple dash lines is truthful or not. 
